...
const BYPASS = [
  ...
  "/download",
  // Публичните изображения (задача 17m-b): адресът на файл няма език.
  // Правилото за разширение долу и без това ги пуска — това тук е
  // изричното намерение, да не зависи от формата на ключа.
  "/media",
];
