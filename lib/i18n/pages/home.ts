...
const bg = {
  ...
  hero: {
    kicker: "Курсове по немски · A1–B2 · за българи в Германия",
    titleLead: "Немски, който",
    titleAccent: "остава",
    lede: "Курсове на живо с Василена Нюрнбергер за българи, които живеят и работят в Германия. Започваш от правилното ниво и вървиш по ясен път от A1 до B2, с индивидуално отношение.",
    ctaPrimary: "Заяви безплатно обаждане",
    ctaSecondary: "Направи теста за ниво",
    badgeLive: "живо онлайн",
    badgeLevels: "A1–B2 за българи в Германия",
    startLabel: "старт",
  ...
  why: {
    ...
    items: [
      ...
      {
        // БЕЗ число за размера на групата (15.08.2026): реално таван няма,
        // а „8–10 души" беше обещание, което не се спазва. Ползата остава,
        // формулирана с думите на самата Василена от рекламата ѝ —
        // „индивидуално отношение". Виж docs/СЪДЪРЖАНИЕ-от-Василена.md.
        tag: "Твоят ред",
        title: "Всеки стига до думата",
        body: "Часът е воден така, че да говориш ти, а не да седиш с изключена камера, докато времето изтече. Индивидуално отношение към всеки курсист.",
      },
    ],
  },
  ...
  courses: {
    ...
    // A1–B2. C1 и C2 НЕ се предлагат (потвърдено от Василена 15.08.2026 —
    // тя работи 45 ч в реално време до B2). Мокъпът стигаше до C1, но
    // мокъпът е предположение, а това е отговорът на самата преподавателка.
    levels: [
      { level: "A1", name: "Начинаещи", body: "Първи думи, представяне, числа и всекидневието.", note: "живо онлайн" },
      { level: "A2", name: "Основи", body: "Минало време, пазаруване, разговор при лекаря.", note: "живо онлайн" },
      { level: "B1", name: "Самостоятелност", body: "Работа, Anmeldung, писма до институции.", note: "най-търсеното ниво" },
      { level: "B2", name: "Увереност", body: "Дискусии, интервю за работа, професионален немски.", note: "живо онлайн" },
    ],
...
const de: HomeCopy = {
  ...
  hero: {
    kicker: "Deutschkurse · A1–B2 · für Bulgaren in Deutschland",
    titleLead: "Deutsch, das",
    titleAccent: "bleibt",
    lede: "Live-Kurse mit Vasilena Nürnberger für Bulgaren, die in Deutschland leben und arbeiten. Du startest auf dem richtigen Niveau und gehst einen klaren Weg von A1 bis B2 — mit individueller Betreuung.",
    ctaPrimary: "Kostenlosen Rückruf anfragen",
    ctaSecondary: "Einstufungstest machen",
    badgeLive: "live online",
    badgeLevels: "A1–B2 für Bulgaren in Deutschland",
    startLabel: "Start",
    startValue: "01.09.2026",
  ...
  why: {
    ...
    items: [
      ...
      {
        tag: "Du bist dran",
        title: "Jede und jeder kommt zu Wort",
        body: "Die Stunde ist so geführt, dass du sprichst, statt dich hinter ausgeschalteter Kamera zu verstecken, bis die Zeit um ist. Individuelle Betreuung für jede Teilnehmerin und jeden Teilnehmer.",
      },
    ],
  },
  ...
  courses: {
    ...
    levels: [
      { level: "A1", name: "Anfänger", body: "Erste Wörter, sich vorstellen, Zahlen und Alltag.", note: "live online" },
      { level: "A2", name: "Grundlagen", body: "Vergangenheit, Einkaufen, Gespräch beim Arzt.", note: "live online" },
      { level: "B1", name: "Selbstständigkeit", body: "Arbeit, Anmeldung, Briefe an Behörden.", note: "das gefragteste Niveau" },
      { level: "B2", name: "Sicherheit", body: "Diskussionen, Bewerbungsgespräch, Berufsdeutsch.", note: "live online" },
    ],
...
const en: HomeCopy = {
  ...
  hero: {
    kicker: "German courses · A1–B2 · for Bulgarians in Germany",
    titleLead: "German that",
    titleAccent: "sticks",
    lede: "Live courses with Vasilena Nürnberger for Bulgarians living and working in Germany. You start at the right level and follow a clear path from A1 to B2, with individual attention.",
    ctaPrimary: "Request a free callback",
    ctaSecondary: "Take the placement test",
    badgeLive: "live online",
    badgeLevels: "A1–B2 for Bulgarians in Germany",
    startLabel: "starts",
    startValue: "01.09.2026",
  ...
  why: {
    ...
    items: [
      ...
      {
        tag: "Your turn",
        title: "Everyone gets to speak",
        body: "The lesson is run so that you do the talking, instead of hiding behind a switched-off camera until time runs out. Individual attention for every student.",
      },
    ],
  },
  ...
  courses: {
    ...
    all: "See all courses",
    levels: [
      { level: "A1", name: "Beginners", body: "First words, introductions, numbers and everyday life.", note: "live online" },
      { level: "A2", name: "Foundations", body: "Past tense, shopping, talking to the doctor.", note: "live online" },
      { level: "B1", name: "Independence", body: "Work, Anmeldung, letters to authorities.", note: "most requested level" },
      { level: "B2", name: "Confidence", body: "Discussions, job interviews, professional German.", note: "live online" },
    ],
