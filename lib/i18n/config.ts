...
//
// Кой език за кого:
//   de — основният. Клиентите са в Германия, сайтът е немски по подразбиране.
//   bg — за българската общност в Нюрнберг и за собствениците.
//   en — за всички останали (Erasmus, международни студенти).
//
 ...
 *
 * Редът е нарочен: искания език → немски (основният) → български
 * (в него въвежда админът, значи винаги е попълнен) → каквото има.
...
export function pick(
  ...
  const chain: Locale[] = [locale, "de", "bg", "en"];
