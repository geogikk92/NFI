...
export const LEGAL_TEXT_VERSIONS = {
  terms: "2026-07-29",
  // Вдигната на 31.07.2026: таблицата в раздел 2 беше непълна — липсваха
  // профилът, сесията и одитният дневник, а сроковете обещаваха изтриване,
  // което нищо не извършваше. Смяна на правен текст БЕЗ вдигане на версия
  // означава, че записаният в ConsentLog хеш вече не отговаря на
  // показвания текст и съгласието не може да се докаже.
  privacy: "2026-07-31",
  widerruf: "2026-07-29",
