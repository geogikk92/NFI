...
// Разширено с "en" на 04.08.2026 (задача 16): сайтът има трети език, а
// страницата за проверка на сертификати го показва — датите там трябва
// да минат ПРЕЗ този файл, не покрай него, заради заключената часова
// зона по-долу. en-GB, не en-US: денят преди месеца, както в Европа.
export type Locale = "de" | "bg" | "en";
