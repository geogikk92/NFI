...
//
// ВНИМАНИЕ (задача 18): този скрипт вижда само маркери В КОДА. Седемте
// текста, които клиентката дължи (За нас, Общност, Контакт), вече НЕ са
// маркери — те са редактируеми блокове и празнотата им е състояние на
// БАЗАТА. За тях проверката е отделна:
//
//   npm run check:content        (или check:content:strict преди деплой)
//
// Двете заедно покриват целия дълг: това тук — правния текст от юриста,
// онова — съдържанието от Василена.
